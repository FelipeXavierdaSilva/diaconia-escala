...
window.DiaconiaSeed = (() => {
  ...
  const diaconos = [
    ...
    { id: "d13", nome: "André", equipeId: "eq02", funcaoMinisterio: "", funcaoDiaconatoId: "", whatsapp: "", restricaoPessoal: "", casado: true, conjugeNome: "Beatriz", conjugeMembroIgreja: true, temFilhos: false, qtdFilhos: 0, filhos: [], filhosNomes: [], filhosVaoIgreja: false, funcoesPermitidas: ["*"], ativo: true },
    { id: "d14", nome: "Beatriz", equipeId: "eq02", funcaoMinisterio: "", funcaoDiaconatoId: "", whatsapp: "", restricaoPessoal: "", casado: true, conjugeNome: "André", conjugeMembroIgreja: true, temFilhos: false, qtdFilhos: 0, filhos: [], filhosNomes: [], filhosVaoIgreja: false, funcoesPermitidas: ["*"], ativo: true },
    { id: "d15", nome: "Daniel", equipeId: "eq02", funcaoMinisterio: "", funcaoDiaconatoId: "", whatsapp: "", restricaoPessoal: "", casado: true, conjugeNome: "Eliane", conjugeMembroIgreja: true, temFilhos: false, qtdFilhos: 0, filhos: [], filhosNomes: [], filhosVaoIgreja: false, funcoesPermitidas: ["*"], ativo: true },
    { id: "d16", nome: "Eliane", equipeId: "eq02", funcaoMinisterio: "", funcaoDiaconatoId: "", whatsapp: "", restricaoPessoal: "", casado: true, conjugeNome: "Daniel", conjugeMembroIgreja: true, temFilhos: false, qtdFilhos: 0, filhos: [], filhosNomes: [], filhosVaoIgreja: false, funcoesPermitidas: ["*"], ativo: true },
  ...
  const casais = [
    ...
    },
    {
      ...
      naoServirJuntos: false,
      ativo: true,
      observacao: "André e Beatriz (Equipe 02)",
    },
    {
      id: "c04",
      diaconoIdA: "d15",
      ...
      naoServirJuntos: false,
      ativo: true,
      observacao: "Daniel e Eliane (Equipe 02)",
    },
  ];
